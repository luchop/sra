...
if(typeof(formatType) == "undefined")
	formatType = "dd"+formatSplitter+monthFormat+formatSplitter+yearFormat; //Format data type//formatType = yearFormat+formatSplitter+monthFormat+formatSplitter+"dd"; //Format data type
...
var DayCol = new Array("L", "M", "M", "J", "V", "S", "D");
if(sundayFirst)
{
...
var MonthCol = new Array("Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Sep","Oct","Nov", "Dic")
