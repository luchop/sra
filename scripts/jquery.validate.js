...
$.extend($.validator, {
	...
	messages: {
		...
		date: "Por favor registre una fecha valida.",
		dateISO: "Please enter a valid date (ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "Por favor ingrese un numero valido.",
		numberDE: "Bitte geben Sie eine Nummer ein.",
		digits: "Solo debe registrar numeros",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Ingrese el mismo valor nuevamente.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("No debe ingresar mas de {0} caracteres."),
		minlength: $.validator.format("Debe introducir {0} caracteres por lo menos."),
		rangelength: $.validator.format("Introduzca un dato de {0} a {1} caracteres de largo."),
