...
function Header()
{
	...
	// pero no se puede en codeigniter, so...
	global $Linea1, $Linea2, $Linea3, $Titulo;
	
	$this->SetFont('Arial', 'B', 9);
	$this->Cell(80, 5, utf8_decode($Linea1), 0, 1, 'C');
	$this->Cell(80, 5, utf8_decode($Linea2), 0, 1, 'C');
	$this->Cell(80, 5, utf8_decode($Linea3), 0, 1, 'C');
	
	$this->Ln(2);
	$this->setFillColor(220, 220, 220);
	$this->SetFont('Arial', 'B', 14);
	$this->Cell(0, 6, utf8_decode($Titulo), 0, 1, 'C', TRUE);
	$this->Ln(3);
}
